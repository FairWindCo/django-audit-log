...
class LastUserField(models.ForeignKey):
    ...
    def __init__(self, to=getattr(settings, 'AUTH_USER_MODEL', 'auth.User'), on_delete=models.SET_NULL, null=True,
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        super(LastUserField, self).contribute_to_class(cls, name, **kwargs)
...
class LastSessionKeyField(models.CharField):
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        super(LastSessionKeyField, self).contribute_to_class(cls, name, **kwargs)
        registry = registration.FieldRegistry(self.__class__)
        registry.add_field(cls, self)
