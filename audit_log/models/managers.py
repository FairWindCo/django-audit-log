...
class AuditLogManager(models.Manager):
    def __init__(self, model, attname, instance=None, ):
        ...
        # set a hidden attribute on the  instance to control weather we should track changes
...
class AuditLog(object):
    ...
    @staticmethod
    def get_logging_fields(model):
        """
        Returns a dictionary mapping of the fields that are used for
        keeping the actual audit log entries.
        """
